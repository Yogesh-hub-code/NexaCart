...
import { CategoryProductsComponent } from './NexaCart/category-products/category-products.component';
...
export const routes: Routes = [
  ...
  // ── Category product listing (storefront) ──
  ...
  { path: 'admin/brands', component: BrandListComponent, canActivate: [adminGuard] },
